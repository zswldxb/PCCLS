...
class PointClsStem(nn.Module):
    def __init__(self, d_in: int, d_out: int, norm: str='BN', act: str='ReLU', *, channels_first: bool=False) -> None:
        super().__init__()
        self.g_k = 16
        self.mlp = MLPND(d_in*3, d_out, norm=norm, act=act, ndim=2, channels_first=channels_first)
